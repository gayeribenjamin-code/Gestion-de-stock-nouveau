...
const fr: Dict = {
  ...
  "cat.manage": "Gérer les catégories",
  "cat.title": "Gérer les catégories",
  "cat.desc": "Créez, renommez ou supprimez vos catégories pour classer vos produits.",
  "cat.newPlaceholder": "Nom de la nouvelle catégorie",
  "cat.add": "Ajouter",
  "cat.empty": "Aucune catégorie pour l'instant. Ajoutez-en une ci-dessus.",
  "cat.productsCount": "{v} produit(s)",
  "cat.created": "Catégorie ajoutée",
  "cat.renamed": "Catégorie renommée",
  "cat.deleted": "Catégorie supprimée",
  "cat.errDuplicate": "Cette catégorie existe déjà",
  "cat.errEmpty": "Le nom ne peut pas être vide",
  "cat.errInUse": "Impossible de supprimer : {v} produit(s) utilisent encore cette catégorie",
  "cat.confirmDelete": "Supprimer la catégorie « {v} » ?",
  "cat.renamePrompt": "Nouveau nom pour « {v} »",
  "cat.rename": "Renommer",
  ...
  "stock.categoryRequired": "Veuillez choisir une catégorie (créez-en une si besoin).",
  ...
  // Factures & clients
  "inv.title": "Factures",
  "inv.subtitle": "Créez des factures complètes : le stock et le chiffre d'affaires sont mis à jour automatiquement.",
  "inv.tabInvoices": "Factures",
  "inv.tabCustomers": "Clients",
  "inv.new": "Nouvelle facture",
  "inv.search": "Rechercher (numéro ou client)...",
  "inv.none": "Aucune facture pour le moment.",
  "inv.colNumber": "Numéro",
  "inv.colDate": "Date",
  "inv.colCustomer": "Client",
  "inv.colItems": "Articles",
  "inv.colTotal": "Total",
  "inv.colStatus": "Statut",
  "inv.colActions": "Actions",
  "inv.status.paid": "Payée",
  "inv.status.unpaid": "Impayée",
  "inv.markPaid": "Marquer payée",
  "inv.markUnpaid": "Marquer impayée",
  "inv.view": "Voir / Imprimer",
  "inv.print": "Imprimer / PDF",
  "inv.delete": "Supprimer",
  "inv.confirmDelete": "Supprimer la facture {v} ? Le stock sera restauré.",
  "inv.deleted": "Facture supprimée. Stock restauré.",
  "inv.deleteError": "Suppression impossible.",
  "inv.created": "Facture créée. Stock et CA mis à jour.",
  "inv.createError": "Impossible de créer la facture.",
  "inv.dialogTitle": "Créer une facture",
  "inv.dialogDesc": "Ajoutez des produits, choisissez un client et enregistrez.",
  "inv.customer": "Client",
  "inv.customerFree": "Client libre (saisie manuelle)",
  "inv.chooseCustomer": "Choisir un client",
  "inv.orTypeName": "Nom du client (facultatif)",
  "inv.payment": "Paiement",
  "inv.statusLabel": "Statut",
  "inv.notes": "Notes (facultatif)",
  "inv.lines": "Produits",
  "inv.addLine": "Ajouter un produit",
  "inv.lineProduct": "Produit",
  "inv.lineQty": "Qté",
  "inv.lineUnit": "P.U.",
  "inv.lineTotal": "Total",
  "inv.removeLine": "Retirer",
  "inv.grandTotal": "Total de la facture",
  "inv.noLine": "Ajoutez au moins un produit.",
  "inv.create": "Créer la facture",
  "inv.creating": "Création...",
  "inv.stockLeft": "{v} en stock",
  // Impression
  "inv.print.invoice": "FACTURE",
  "inv.print.billedTo": "Facturé à",
  "inv.print.date": "Date",
  "inv.print.number": "N° de facture",
  "inv.print.product": "Produit",
  "inv.print.qty": "Qté",
  "inv.print.unitPrice": "Prix unitaire",
  "inv.print.lineTotal": "Total",
  "inv.print.total": "TOTAL",
  "inv.print.payment": "Mode de paiement",
  "inv.print.thanks": "Merci de votre confiance.",
  "inv.print.notFound": "Facture introuvable.",
  "inv.print.back": "Retour aux factures",
  // Clients
  "cust.new": "Nouveau client",
  "cust.search": "Rechercher un client...",
  "cust.none": "Aucun client. Ajoutez-en un pour commencer.",
  "cust.name": "Nom",
  "cust.phone": "Téléphone",
  "cust.email": "Email",
  "cust.address": "Adresse",
  "cust.notes": "Notes",
  "cust.edit": "Modifier le client",
  "cust.add": "Ajouter un client",
  "cust.nameRequired": "Le nom du client est requis.",
  "cust.added": "Client ajouté.",
  "cust.updated": "Client mis à jour.",
  "cust.deleted": "Client supprimé.",
  "cust.saveError": "Enregistrement impossible.",
  "cust.deleteError": "Suppression impossible.",
  "cust.confirmDelete": "Supprimer le client {v} ?",
  "cust.invoiceCount": "{v} facture(s)",
  "cust.totalSpent": "Total dépensé",
  "cust.viewInvoices": "Voir les factures",
  "cust.deleteCustomer": "Supprimer {v}",
}
...
const en: Dict = {
  ...
  "cat.desc": "Create, rename or delete your categories to organize your products.",
  "cat.newPlaceholder": "New category name",
  "cat.add": "Add",
  "cat.empty": "No categories yet. Add one above.",
  "cat.productsCount": "{v} product(s)",
  "cat.created": "Category added",
  "cat.renamed": "Category renamed",
  "cat.deleted": "Category deleted",
  "cat.errDuplicate": "This category already exists",
  "cat.errEmpty": "Name cannot be empty",
  "cat.errInUse": "Cannot delete: {v} product(s) still use this category",
  "cat.confirmDelete": "Delete category \"{v}\"?",
  "cat.renamePrompt": "New name for \"{v}\"",
  "cat.rename": "Rename",
  "cat.delete": "Delete",
  ...
  "stock.categoryRequired": "Please choose a category (create one if needed).",
  ...
  // Invoices & customers
  "inv.title": "Invoices",
  "inv.subtitle": "Create full invoices: stock and revenue update automatically.",
  "inv.tabInvoices": "Invoices",
  "inv.tabCustomers": "Customers",
  "inv.new": "New invoice",
  "inv.search": "Search (number or customer)...",
  ...
  "inv.print": "Print / PDF",
  "inv.delete": "Delete",
  "inv.confirmDelete": "Delete invoice {v}? Stock will be restored.",
  "inv.deleted": "Invoice deleted. Stock restored.",
  "inv.deleteError": "Could not delete.",
  "inv.created": "Invoice created. Stock and revenue updated.",
  "inv.createError": "Could not create the invoice.",
  "inv.dialogTitle": "Create an invoice",
  "inv.dialogDesc": "Add products, choose a customer and save.",
  "inv.customer": "Customer",
  "inv.customerFree": "Walk-in customer (manual entry)",
  "inv.chooseCustomer": "Choose a customer",
  "inv.orTypeName": "Customer name (optional)",
  "inv.payment": "Payment",
  "inv.statusLabel": "Status",
  "inv.notes": "Notes (optional)",
  "inv.lines": "Products",
  "inv.addLine": "Add a product",
  "inv.lineProduct": "Product",
  "inv.lineQty": "Qty",
  "inv.lineUnit": "Unit",
  "inv.lineTotal": "Total",
  "inv.removeLine": "Remove",
  "inv.grandTotal": "Invoice total",
  "inv.noLine": "Add at least one product.",
  "inv.create": "Create invoice",
  "inv.creating": "Creating...",
  "inv.stockLeft": "{v} in stock",
  // Printing
  "inv.print.invoice": "INVOICE",
  "inv.print.billedTo": "Billed to",
  "inv.print.date": "Date",
  "inv.print.number": "Invoice no.",
  "inv.print.product": "Product",
  "inv.print.qty": "Qty",
  "inv.print.unitPrice": "Unit price",
  "inv.print.lineTotal": "Total",
  "inv.print.total": "TOTAL",
  "inv.print.payment": "Payment method",
  "inv.print.thanks": "Thank you for your business.",
  "inv.print.notFound": "Invoice not found.",
  "inv.print.back": "Back to invoices",
  // Customers
  "cust.new": "New customer",
  "cust.search": "Search a customer...",
  "cust.none": "No customers. Add one to get started.",
  "cust.name": "Name",
  "cust.phone": "Phone",
  "cust.email": "Email",
  ...
  "cust.add": "Add a customer",
  "cust.nameRequired": "The customer name is required.",
  "cust.added": "Customer added.",
  "cust.updated": "Customer updated.",
  "cust.deleted": "Customer deleted.",
  "cust.saveError": "Could not save.",
  "cust.deleteError": "Could not delete.",
  "cust.confirmDelete": "Delete customer {v}?",
  "cust.invoiceCount": "{v} invoice(s)",
  "cust.totalSpent": "Total spent",
  "cust.viewInvoices": "View invoices",
  "cust.deleteCustomer": "Delete {v}",
}
